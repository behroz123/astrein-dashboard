...
const DICT: Record<Lang, Record<string, string>> = {
  de: {
    ...
    "contract.provider": "Anbieter",
    "contract.accountNumber": "Vertragskonto-Nummer",
    "contract.meterNumber": "Zähler-Nummer",
    "contract.meterReading": "Zählerstand (kWh)",
    "contract.monthlyPayment": "Monatlicher Abschlag (EUR)",
...
count: "Anzahl",
    ...
    "contract.open": "Öffnen",
    "contract.pdfDocument": "PDF-Datei",
    "contract.uploading": "PDF wird hochgeladen...",
  ...
  en: {
    ...
    "contract.uploading": "Uploading PDF...",
