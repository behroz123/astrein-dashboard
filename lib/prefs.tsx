...
const DICT: Record<Lang, Record<string, string>> = {
  de: {
    ...
    "admin.workers": "Arbeiter",
    "admin.workers.title": "Arbeiterverwaltung",
    "admin.workers.subtitle": "Verwalten Sie Arbeiterzugänge und Berechtigungen",
    "admin.workers.empty": "Keine Arbeiter gefunden",
    "admin.workers.loading": "Arbeiter werden geladen...",
    "admin.workers.add": "Neuer Arbeiter",
    "admin.workers.edit": "Bearbeiten",
    "admin.workers.delete": "Löschen",
    "admin.workers.role": "Rolle",
    "admin.workers.role.admin": "Administrator",
    "admin.workers.role.employee": "Mitarbeiter",
    "admin.workers.name": "Name",
    "admin.workers.email": "E-Mail",
    "admin.workers.confirm": "Bestätigen",
    "admin.workers.cancel": "Abbrechen",
    "admin.workers.save": "Speichern",
    "profile.edit": "Profil bearbeiten",
    "profile.name": "Name",
    "profile.password": "Passwort",
    "profile.passwordConfirm": "Passwort bestätigen",
    ...
    "messages.confirmDelete": "Sind Sie sicher, dass Sie dies löschen möchten?",
    ...
    "immobilien.description": "Zentrale Verwaltung für Ihre Immobilien, Verträge und Mieter",
    ...
    "immobilien.item.rental": "Mietvertrag",
    "immobilien.item.rental.desc": "Hauptmietvertrag erstellen und verwalten",
    "immobilien.item.sublease": "Untermietvertrag",
    "immobilien.item.sublease.desc": "Untermietvertrag erstellen und verwalten",
    "immobilien.item.keyhandover": "Schlüsselübergabe",
    "immobilien.item.keyhandover.desc": "Übergabeprotokoll für Schlüssel",
    "immobilien.item.apartmentcheck": "Wohnung checken",
    "immobilien.item.apartmentcheck.desc": "Zustand dokumentieren und prüfen",
    "immobilien.item.electricity": "Stromvertrag",
    "immobilien.item.electricity.desc": "Stromverträge verwalten",
    "immobilien.item.water": "Wasservertrag",
    "immobilien.item.water.desc": "Wasserverträge verwalten",
    "immobilien.item.gas": "Gasvertrag",
    "immobilien.item.gas.desc": "Gasverträge verwalten",
    "immobilien.item.moveins": "Einzüge",
    "immobilien.item.moveins.desc": "Neue Mieter verwalten",
    "immobilien.item.moveouts": "Auszüge",
    "immobilien.item.moveouts.desc": "Auszüge dokumentieren",
    "immobilien.item.apartments": "Wohnungen",
    "immobilien.item.apartments.desc": "Wohnungsübersicht",
    "common.open": "Öffnen",
...
count: "Anzahl",
    ...
    "wohnungen.newWohnung": "Neue Wohnung",
    "wohnungen.stats.total": "Gesamt",
    "wohnungen.stats.verfuegbar": "Verfügbar",
    "wohnungen.stats.vermietet": "Vermietet",
    "wohnungen.stats.renovierung": "Renovierung",
    "wohnungen.stats.zimmer": "Zimmer",
    "wohnungen.stats.betten": "Betten",
    "wohnungen.stats.belegt": "Belegt",
    "wohnungen.rent.total": "Gesamtmiete",
    "wohnungen.rent.income": "Einnahmen",
    "wohnungen.rent.difference": "Differenz",
    "wohnungen.payments.open": "Offene Mieten",
    "wohnungen.payments.overdue": "Überfällig",
    "wohnungen.form.address": "Adresse",
    "wohnungen.form.city": "Stadt/PLZ",
    "wohnungen.form.rooms": "Zimmer",
    "wohnungen.form.sqm": "m²",
    "wohnungen.form.rent": "Miete (€)",
    "wohnungen.form.deposit": "Kaution (€)",
    "wohnungen.form.status": "Status",
    "wohnungen.form.tenant": "Aktueller Mieter",
    "wohnungen.form.rentStart": "Mietbeginn",
    "wohnungen.form.rentEnd": "Mietende",
    "wohnungen.form.notes": "Notizen",

    // Fahrzeuge
    "fahrzeuge.title": "Firmenfahrzeuge",
    "fahrzeuge.description": "Verwalten Sie alle Firmenfahrzeuge, Fahrer und Dokumente",
    "fahrzeuge.newVehicle": "➕ Neues Fahrzeug",
    "fahrzeuge.edit": "Fahrzeug bearbeiten",
    ...
    "wohnungChecken.protocols": "Protokolle",
    "wohnungChecken.allProtocols": "Alle gespeicherten Übergabe- und Rückgabeprotokolle",
    "wohnungChecken.moveIn": "Einzugsprotokoll",
    "wohnungChecken.createProtocol": "Erstellen Sie detaillierte Protokolle beim Einzug und Auszug.",
    "wohnungChecken.photoDocs": "Fotodokumentation",

    // Reservierungen & Inventar
    "inventory.title": "Bestandsprotokolle",
    "inventory.stockCheck": "Bestandsaufnahme",
    "inventory.checkAll": "Alle überprüfen",
  ...
  en: {
    ...
    "immobilien.description": "Central management for your properties, contracts and tenants",
    ...
    "immobilien.item.rental": "Rental Agreement",
    "immobilien.item.rental.desc": "Create and manage main rental contracts",
    "immobilien.item.sublease": "Sublease Agreement",
    "immobilien.item.sublease.desc": "Create and manage sublease contracts",
    "immobilien.item.keyhandover": "Key Handover",
    "immobilien.item.keyhandover.desc": "Handover protocol for keys",
    "immobilien.item.apartmentcheck": "Apartment Inspection",
    "immobilien.item.apartmentcheck.desc": "Document and check condition",
    "immobilien.item.electricity": "Electricity Contract",
    "immobilien.item.electricity.desc": "Manage electricity contracts",
    "immobilien.item.water": "Water Contract",
    "immobilien.item.water.desc": "Manage water contracts",
    "immobilien.item.gas": "Gas Contract",
    "immobilien.item.gas.desc": "Manage gas contracts",
    "immobilien.item.moveins": "Move-ins",
    "immobilien.item.moveins.desc": "Manage new tenants",
    "immobilien.item.moveouts": "Move-outs",
    "immobilien.item.moveouts.desc": "Document move-outs",
    "immobilien.item.apartments": "Apartments",
    "immobilien.item.apartments.desc": "Apartment overview",
    "common.open": "Open",
...
count: "Count",
    ...
    "wohnungen.newWohnung": "New Apartment",
    "wohnungen.stats.total": "Total",
    "wohnungen.stats.verfuegbar": "Available",
    "wohnungen.stats.vermietet": "Rented",
    "wohnungen.stats.renovierung": "Renovation",
    "wohnungen.stats.zimmer": "Rooms",
    "wohnungen.stats.betten": "Beds",
    "wohnungen.stats.belegt": "Occupied",
    "wohnungen.rent.total": "Total Rent",
    "wohnungen.rent.income": "Income",
    "wohnungen.rent.difference": "Difference",
    "wohnungen.payments.open": "Open Payments",
    "wohnungen.payments.overdue": "Overdue",
    "wohnungen.form.address": "Address",
    "wohnungen.form.city": "City/Zip",
    "wohnungen.form.rooms": "Rooms",
    "wohnungen.form.sqm": "m²",
    "wohnungen.form.rent": "Rent (€)",
    "wohnungen.form.deposit": "Deposit (€)",
    "wohnungen.form.status": "Status",
    "wohnungen.form.tenant": "Current Tenant",
    "wohnungen.form.rentStart": "Lease Start",
    "wohnungen.form.rentEnd": "Lease End",
    "wohnungen.form.notes": "Notes",

    // Fahrzeuge
    "fahrzeuge.title": "Company Vehicles",
    "fahrzeuge.description": "Manage all company vehicles, drivers and documents",
    "fahrzeuge.newVehicle": "➕ New Vehicle",
    "fahrzeuge.edit": "Edit Vehicle",
    ...
    "wohnungChecken.protocols": "Protocols",
    "wohnungChecken.allProtocols": "All saved handover and return protocols",
    "wohnungChecken.moveIn": "Move-In Protocol",
    "wohnungChecken.createProtocol": "Create detailed protocols for move-in and move-out.",
    "wohnungChecken.photoDocs": "Photo Documentation",

    // Reservierungen & Inventar
    "inventory.title": "Stock Protocols",
    "inventory.stockCheck": "Stock Check",
    "inventory.checkAll": "Check All",
    ...
    "admin.workers.title": "Worker Management",
    "admin.workers.subtitle": "Manage worker access and permissions",
    "admin.workers.empty": "No workers found",
    "admin.workers.loading": "Loading workers...",
    "admin.workers.add": "Add Worker",
    "admin.workers.edit": "Edit",
    "admin.workers.delete": "Delete",
    "admin.workers.role": "Role",
    "admin.workers.role.admin": "Administrator",
    "admin.workers.role.employee": "Employee",
    "admin.workers.name": "Name",
    "admin.workers.email": "Email",
    "admin.workers.confirm": "Confirm",
    "admin.workers.cancel": "Cancel",
    "admin.workers.save": "Save",
...
count: "Sayı",
    ...
    "immobilien.description": "Mülkleriniz, sözleşmeleriniz ve kiracılarınız için merkezi yönetim",
    ...
    "immobilien.item.rental": "Kiralama Sözleşmesi",
    "immobilien.item.rental.desc": "Ana kiralama sözleşmesini oluşturun ve yönetin",
    "immobilien.item.sublease": "Alt Kiralama Sözleşmesi",
    "immobilien.item.sublease.desc": "Alt kiralama sözleşmesini oluşturun ve yönetin",
    "immobilien.item.keyhandover": "Anahtar Teslimi",
    "immobilien.item.keyhandover.desc": "Anahtar teslimi protokolü",
    "immobilien.item.apartmentcheck": "Daire Kontrolü",
    "immobilien.item.apartmentcheck.desc": "Durumu belgeleyip kontrol edin",
    "immobilien.item.electricity": "Elektrik Sözleşmesi",
    "immobilien.item.electricity.desc": "Elektrik sözleşmelerini yönetin",
    "immobilien.item.water": "Su Sözleşmesi",
    "immobilien.item.water.desc": "Su sözleşmelerini yönetin",
    "immobilien.item.gas": "Gaz Sözleşmesi",
    "immobilien.item.gas.desc": "Gaz sözleşmelerini yönetin",
    "immobilien.item.moveins": "Girenler",
    "immobilien.item.moveins.desc": "Yeni kiracıları yönetin",
    "immobilien.item.moveouts": "Taşınanlar",
    "immobilien.item.moveouts.desc": "Taşınmaları belgeleyip",
    "immobilien.item.apartments": "Daireler",
    "immobilien.item.apartments.desc": "Daire genel bakışı",
    "common.open": "Aç",
    ...
    "common.confirmDelete": "Gerçekten silinsin mi?",

    // Wohnungen
    "wohnungen.title": "Daire Yönetimi",
    "wohnungen.newWohnung": "Yeni Daire",
    "wohnungen.stats.total": "Toplam",
    "wohnungen.stats.verfuegbar": "Mevcut",
    "wohnungen.stats.vermietet": "Kiralı",
    "wohnungen.stats.renovierung": "Renovasyon",
    "wohnungen.stats.zimmer": "Odalar",
    "wohnungen.stats.betten": "Yataklar",
    "wohnungen.stats.belegt": "Dolu",
    "wohnungen.rent.total": "Toplam Kira",
    "wohnungen.rent.income": "Gelir",
    "wohnungen.rent.difference": "Fark",
    "wohnungen.payments.open": "Açık Ödemeler",
    "wohnungen.payments.overdue": "Vadesi Geçmiş",
    "wohnungen.form.address": "Adres",
    "wohnungen.form.city": "Şehir/Posta Kodu",
    "wohnungen.form.rooms": "Odalar",
    "wohnungen.form.sqm": "m²",
    "wohnungen.form.rent": "Kira (€)",
    "wohnungen.form.deposit": "Teminat (€)",
    "wohnungen.form.status": "Durum",
    "wohnungen.form.tenant": "Mevcut Kiracı",
    "wohnungen.form.rentStart": "Kira Başlangıcı",
    "wohnungen.form.rentEnd": "Kira Sonu",
    "wohnungen.form.notes": "Notlar",

    // Fahrzeuge
    "fahrzeuge.title": "Şirket Araçları",
    "fahrzeuge.description": "Tüm şirket araçlarını, şoförleri ve belgeleri yönetin",
    "fahrzeuge.newVehicle": "➕ Yeni Araç",
    "fahrzeuge.edit": "Araç Düzenle",
    ...
    "wohnungChecken.protocols": "Protokoller",
    "wohnungChecken.allProtocols": "Kaydedilen tüm teslim ve iade protokolleri",
    "wohnungChecken.moveIn": "Taşınma Protokolü",
    "wohnungChecken.createProtocol": "Taşınma ve taşınma çıkışı için detaylı protokoller oluşturun.",
    "wohnungChecken.photoDocs": "Fotoğraf Belgelendirmesi",

    // Reservierungen & Inventar
    "inventory.title": "Stok Protokolleri",
    "inventory.stockCheck": "Stok Kontrolü",
    "inventory.checkAll": "Tümünü Kontrol Et",
    "inventory.allStatuses": "Tüm Durumlar",
    ...
    "admin.workers": "Çalışanlar",
    "admin.workers.title": "Çalışan Yönetimi",
    "admin.workers.subtitle": "Çalışan erişim ve izinlerini yönetin",
    "admin.workers.empty": "Çalışan bulunamadı",
    "admin.workers.loading": "Çalışanlar yükleniyor...",
    "admin.workers.add": "Çalışan Ekle",
    "admin.workers.edit": "Düzenle",
    "admin.workers.delete": "Sil",
    "admin.workers.role": "Rol",
    "admin.workers.role.admin": "Yönetici",
    "admin.workers.role.employee": "Çalışan",
    "admin.workers.name": "Ad",
    "admin.workers.email": "E-posta",
    "admin.workers.confirm": "Onayla",
    "admin.workers.cancel": "İptal",
    "admin.workers.save": "Kaydet",
    "profile.edit": "Profili Düzenle",
    "profile.name": "Ad",
    "profile.password": "Şifre",
    "profile.passwordConfirm": "Şifreyi Onayla",
    "profile.passwordCurrent": "Mevcut Şifre",
    "profile.passwordNew": "Yeni Şifre",
    "profile.changePassword": "Şifre Değiştir",
    "profile.save": "Kaydet",
    "profile.cancel": "İptal",
    "profile.saved": "Profil kaydedildi",
    "profile.error": "Profil kaydedilirken hata",
    ...
    "messages.success": "Başarıyla kaydedildi",
    "messages.error": "Bir hata oluştu",
    "messages.confirmDelete": "Bunu silmek istediğinizden emin misiniz?",
...
count: "Număr",
    ...
    "immobilien.description": "Gestionare centrală pentru proprietățile, contractele și chiriaşii dvs.",
    "immobilien.modules": "Module",
    ...
    "immobilien.item.rental": "Contract de Închiriere",
    "immobilien.item.rental.desc": "Creați și gestionați contractul principal de închiriere",
    "immobilien.item.sublease": "Contract Subînchiriere",
    "immobilien.item.sublease.desc": "Creați și gestionați contractul de subînchiriere",
    "immobilien.item.keyhandover": "Predare Chei",
    "immobilien.item.keyhandover.desc": "Protocol de predare a cheilor",
    "immobilien.item.apartmentcheck": "Inspectare Apartament",
    "immobilien.item.apartmentcheck.desc": "Documentați și verificați starea",
    "immobilien.item.electricity": "Contract Electricitate",
    "immobilien.item.electricity.desc": "Gestionați contractele de electricitate",
    "immobilien.item.water": "Contract Apă",
    "immobilien.item.water.desc": "Gestionați contractele de apă",
    "immobilien.item.gas": "Contract Gaz",
    "immobilien.item.gas.desc": "Gestionați contractele de gaz",
    "immobilien.item.moveins": "Intrări",
    "immobilien.item.moveins.desc": "Gestionați noii chiași",
    "immobilien.item.moveouts": "Mutări",
    "immobilien.item.moveouts.desc": "Documentați mutările",
    "immobilien.item.apartments": "Apartamente",
    "immobilien.item.apartments.desc": "Prezentare generală apartamente",
    ...
    "wohnungen.newWohnung": "Apartament nou",
    "wohnungen.stats.total": "Total",
    "wohnungen.stats.verfuegbar": "Disponibil",
    "wohnungen.stats.vermietet": "Închiriat",
    "wohnungen.stats.renovierung": "Renovare",
    "wohnungen.stats.zimmer": "Camere",
    "wohnungen.stats.betten": "Paturi",
    "wohnungen.stats.belegt": "Ocupat",
    "wohnungen.rent.total": "Chirie totală",
    "wohnungen.rent.income": "Venit",
    "wohnungen.rent.difference": "Diferență",
    "wohnungen.payments.open": "Plăți deschise",
    "wohnungen.payments.overdue": "Scadent",
    "wohnungen.form.address": "Adresă",
    "wohnungen.form.city": "Oraș/Cod poștal",
    "wohnungen.form.rooms": "Camere",
    "wohnungen.form.sqm": "m²",
    "wohnungen.form.rent": "Chirie (€)",
    "wohnungen.form.deposit": "Depozit (€)",
    "wohnungen.form.status": "Statut",
    "wohnungen.form.tenant": "Chiriaș curent",
    "wohnungen.form.rentStart": "Începerea chirii",
    "wohnungen.form.rentEnd": "Sfârșitul chirii",
    "wohnungen.form.notes": "Note",

    // Fahrzeuge
    "fahrzeuge.title": "Vehicule de companie",
    "fahrzeuge.description": "Gestionați toate vehiculele companiei, șoferii și documente",
    "fahrzeuge.newVehicle": "➕ Vehicul nou",
    "fahrzeuge.edit": "Editare vehicul",
    ...
    "wohnungChecken.protocols": "Protocol",
    "wohnungChecken.allProtocols": "Toate protocoalele de predare și returnare salvate",
    "wohnungChecken.moveIn": "Protocol de mutare",
    "wohnungChecken.createProtocol": "Creați protocoale detaliate pentru mutare și evacuare.",
    "wohnungChecken.photoDocs": "Documentare fotografică",

    // Reservierungen & Inventar
    "inventory.title": "Protocoale stoc",
    "inventory.stockCheck": "Verificare stoc",
    "inventory.checkAll": "Verificare totală",
    "inventory.allStatuses": "Toate statusurile",
    ...
    "admin.workers": "Lucrători",
    "admin.workers.title": "Gestionare lucrători",
    "admin.workers.subtitle": "Gestionați accesul și permisiunile lucrătorilor",
    "admin.workers.empty": "Niciun lucrător găsit",
    "admin.workers.loading": "Se încarcă lucrătorii...",
    "admin.workers.add": "Adaugă Lucrător",
    "admin.workers.edit": "Editează",
    "admin.workers.delete": "Șterge",
    "admin.workers.role": "Rol",
    "admin.workers.role.admin": "Administrator",
    "admin.workers.role.employee": "Angajat",
    "admin.workers.name": "Nume",
    "admin.workers.email": "E-mail",
    "admin.workers.confirm": "Confirmă",
    "admin.workers.cancel": "Anulează",
    "admin.workers.save": "Salvează",
    "profile.edit": "Editează Profil",
    "profile.name": "Nume",
    "profile.password": "Parolă",
    "profile.passwordConfirm": "Confirmă Parola",
    "profile.passwordCurrent": "Parolă Curentă",
    "profile.passwordNew": "Parolă Nouă",
    ...
    "validation.passwordMismatch": "Parolele nu se potrivesc",
    "validation.passwordTooShort": "Parola trebuie să aibă cel puțin 8 caractere",
    "validation.invalidEmail": "Adresă de e-mail nevalidă",
    "validation.required": "Acest câmp este obligatoriu",
    "messages.success": "Salvat cu succes",
    "messages.error": "A apărut o eroare",
    "messages.confirmDelete": "Sunteți sigur că doriți să ștergeți aceasta?",
    "table.noData": "Nu sunt date disponibile",
...
count: "Количество",
    ...
    "immobilien.description": "Централизованное управление вашей недвижимостью, контрактами и арендаторами",
    ...
    "immobilien.item.rental": "Договор аренды",
    "immobilien.item.rental.desc": "Создавайте и управляйте основным договором аренды",
    "immobilien.item.sublease": "Договор субаренды",
    "immobilien.item.sublease.desc": "Создавайте и управляйте договором субаренды",
    "immobilien.item.keyhandover": "Передача ключей",
    "immobilien.item.keyhandover.desc": "Протокол передачи ключей",
    "immobilien.item.apartmentcheck": "Проверка квартиры",
    "immobilien.item.apartmentcheck.desc": "Задокументируйте и проверьте состояние",
    "immobilien.item.electricity": "Договор электроэнергии",
    "immobilien.item.electricity.desc": "Управляйте договорами электроэнергии",
    "immobilien.item.water": "Договор водоснабжения",
    "immobilien.item.water.desc": "Управляйте договорами водоснабжения",
    "immobilien.item.gas": "Договор газоснабжения",
    "immobilien.item.gas.desc": "Управляйте договорами газоснабжения",
    "immobilien.item.moveins": "Заезды",
    "immobilien.item.moveins.desc": "Управляйте новыми арендаторами",
    "immobilien.item.moveouts": "Съезды",
    "immobilien.item.moveouts.desc": "Задокументируйте съезды",
    "immobilien.item.apartments": "Квартиры",
    "immobilien.item.apartments.desc": "Обзор квартир",
    "common.open": "Открыть",
    ...
    "wohnungen.newWohnung": "Новая квартира",
    "wohnungen.stats.total": "Всего",
    "wohnungen.stats.verfuegbar": "Доступно",
    "wohnungen.stats.vermietet": "Сдано в аренду",
    "wohnungen.stats.renovierung": "Ремонт",
    "wohnungen.stats.zimmer": "Комнаты",
    "wohnungen.stats.betten": "Кровати",
    "wohnungen.stats.belegt": "Занято",
    "wohnungen.rent.total": "Общий доход",
    "wohnungen.rent.income": "Доход",
    "wohnungen.rent.difference": "Разница",
    "wohnungen.payments.open": "Открытые платежи",
    "wohnungen.payments.overdue": "Просрочено",
    "wohnungen.form.address": "Адрес",
    "wohnungen.form.city": "Город/Почтовый индекс",
    "wohnungen.form.rooms": "Комнаты",
    "wohnungen.form.sqm": "м²",
    "wohnungen.form.rent": "Аренда (€)",
    "wohnungen.form.deposit": "Депозит (€)",
    "wohnungen.form.status": "Статус",
    "wohnungen.form.tenant": "Текущий арендатор",
    "wohnungen.form.rentStart": "Начало аренды",
    "wohnungen.form.rentEnd": "Конец аренды",
    "wohnungen.form.notes": "Заметки",

    // Fahrzeuge
    "fahrzeuge.title": "Служебные автомобили",
    "fahrzeuge.description": "Управляйте всеми служебными автомобилями, водителями и документами",
    "fahrzeuge.newVehicle": "➕ Новый автомобиль",
    "fahrzeuge.edit": "Редактировать автомобиль",
    ...
    "wohnungChecken.protocols": "Протоколы",
    "wohnungChecken.allProtocols": "Все сохраненные протоколы передачи и возврата",
    "wohnungChecken.moveIn": "Протокол заселения",
    "wohnungChecken.createProtocol": "Создавайте подробные протоколы для заселения и выселения.",
    "wohnungChecken.photoDocs": "Фотографическая документация",

    // Reservierungen & Inventar
    "inventory.title": "Протоколы инвентаризации",
    "inventory.stockCheck": "Проверка инвентаря",
    "inventory.checkAll": "Проверить все",
    ...
    "admin.workers": "Рабочие",
    "admin.workers.title": "Управление рабочими",
    "admin.workers.subtitle": "Управляйте доступом и правами рабочих",
    "admin.workers.empty": "Рабочие не найдены",
    "admin.workers.loading": "Загрузка рабочих...",
    "admin.workers.add": "Добавить рабочего",
    "admin.workers.edit": "Редактировать",
    "admin.workers.delete": "Удалить",
    "admin.workers.role": "Роль",
    "admin.workers.role.admin": "Администратор",
    "admin.workers.role.employee": "Сотрудник",
    "admin.workers.name": "Имя",
    "admin.workers.email": "Электронная почта",
    "admin.workers.confirm": "Подтвердить",
    "admin.workers.cancel": "Отмена",
    ...
    "profile.error": "Ошибка при сохранении профиля",
    "validation.passwordMismatch": "Пароли не совпадают",
    "validation.passwordTooShort": "Пароль должен содержать минимум 8 символов",
    "validation.invalidEmail": "Некорректный адрес электронной почты",
    "validation.required": "Это поле обязательно",
    "messages.success": "Успешно сохранено",
    "messages.error": "Произошла ошибка",
    "messages.confirmDelete": "Вы уверены, что хотите это удалить?",
