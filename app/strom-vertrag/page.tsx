...
export default function StromVertragPage() {
  ...
  async function handleSave() {
    if (!propertyName.trim() || !providerName.trim()) {
      alert("Bitte Objektname und Stromanbieter ausfüllen!");
      return;
    }
    ...
    try {
      ...
      if (pdfFile) {
        ...
        const fileRef = ref(
          storage,
          `electricity-contracts/${Date.now()}_${pdfFile.name}`
        );
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-white">
                {selectedContract ? "Stromvertrag bearbeiten" : "Neuer Stromvertrag"}
              </h1>
        ...
        <div className="rounded-[28px] surface p-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs text-white/60">Stromanbieter *</label>
                  <input
                    type="text"
                    value={providerName}
                    onChange={(e) => setProviderName(e.target.value)}
                    placeholder="z.B. Stadtwerke, E.ON, Vattenfall"
                    className="input mt-2"
                  />
                </div>
                <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-xs text-white/60">Aktueller Zähler-Stand (kWh)</label>
                  <input
                    type="text"
                    value={meterReading}
    ...
    <div className="space-y-6">
      ...
      {contracts.length === 0 ? (
        <div className="rounded-[28px] surface p-12 text-center">
          ...
          <div className="text-lg text-white/80 mb-2">Noch keine Stromverträge</div>
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <span className="text-white/50">Anbieter:</span>
                ...
                {contract.meterReading && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white/70">{contract.meterReading} kWh</span>
                  </div>
                )}
